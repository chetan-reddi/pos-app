...
<div id="invoice-POS" ref={componentRef}>
            <center id="top">
              <div className="logo" />
              <div className="info">
                <h2>Fresh Garden Bowls</h2>
                <p> Contact : +1 950-748-7474 | Kitchener,ON</p>
              </div>
              {/*End Info*/}
            </center>
            {/*End InvoiceTop*/}
